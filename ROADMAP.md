...
- Pendiente de verificación antes de publicar: reintentos concurrentes o con pérdida de respuesta y bloqueo de UPDATE/DELETE directo sobre `detalle_pedido`. La ronda confirmada no cubre esos casos.
