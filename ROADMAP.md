...
- Pendiente de verificación: solicitudes realmente concurrentes, recuperación después de recargar/cerrar la página y una caída real de red. La prueba superada solo simuló la pérdida de confirmación con la página abierta. También sigue pendiente antes de publicar comprobar el bloqueo de UPDATE/DELETE directo sobre `detalle_pedido`.
